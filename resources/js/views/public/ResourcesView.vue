...
const khText = {
  ...
  'Humaneti is a multi-tenant operations platform covering People, Attendance, Leave, Payroll, Assets, Purchase Requests, Expense Claims, Projects, and Announcements. It provides workflow approvals, role permissions, and complete activity traceability.':
    'ក្រុមហ៊ុន ហ៊ូម៉ាណេទី ជាវេទិកាប្រតិបត្តិការ Multi-Tenant ដែលគ្របដណ្តប់បុគ្គលិក វត្តមាន ច្បាប់ បៀវត្សរ៍ ទ្រព្យសម្បត្តិ សំណើទិញ ការស្នើសុំសងថ្លៃចំណាយ គម្រោង និងសេចក្តីប្រកាស។ វាផ្តល់ការអនុម័តតាមលំហូរការងារ សិទ្ធិតាមតួនាទី និងការតាមដានសកម្មភាពពេញលេញ។',
  ...
  'Expense Claim Guide': 'មគ្គុទេសក៍ការស្នើសុំសងថ្លៃចំណាយ',
